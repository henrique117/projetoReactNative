...
export default function EnviarMensagem({ navigation }: PrincipalTypes) {
    ...
    const handleChange = (item:IMensagem) => {
        setData({ ...data, ...item })
    }
                        ...
                        <KeyboardAvoidingView style={styles.containerForm}>
                            ...
                            <View style={styles.select}>
                                <MultiSelect
                                    ...
                                    selectedItemTextColor={colors.backGreen}
                                    tagBorderColor={colors.backGreen}
                                    tagTextColor={colors.backGreen}
                                    submitButtonColor={colors.backGreen}
